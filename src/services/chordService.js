...
//             if (NOTES[noteIndex].enharmonics[0].includes("b")) {
//                 return NOTES[noteIndex].name
//             } else {
//                 return NOTES[noteIndex].enharmonics[0]
//             }
//         }
//     } else if (root.includes("b")) {
//         if (interval === 4 || interval == 11) {
//             if (NOTES[noteIndex].name.includes("#")) {
//                 return NOTES[noteIndex].enharmonics[0]
//             } else {
//                 return NOTES[noteIndex].name
//             }
